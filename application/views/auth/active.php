...
<head>
	...
	<title>Verify - <?php echo APPS_NAME?></title>
    ...
    <link href="<?=base_url('themes/admin/assets/css/authentication/form-2.css')?>" rel="stylesheet" type="text/css" />
...
<body class="form no-image-content">
                ...
                <div class="form-container">
                    <div class="form-content">
                    	<div class="d-flex user-meta">
                            <div class="">
                                <p class="">Verify Apps</p>
                            </div>
                        </div>
                        <form class="text-left" autocomplete="off" action="<?=base_url('verify/get')?>" method="POST">
                            <div class="form">
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        <label for="password">Apps Code</label>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                    <input id="password" name="code" required type="password" class="form-control" placeholder="Verify Code">
    ...
    <script src="<?=base_url('themes/admin/assets/js/authentication/form-2.js')?>"></script>

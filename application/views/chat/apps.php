...
<head>
	...
	<link href="<?=base_url('themes/admin/assets/css/apps/mailing-chat.css')?>" rel="stylesheet" type="text/css" />
</head>
<body class="sidebar-noneoverflow application">
                    	...
                    	<div class="col-xl-12 col-lg-12 col-md-12">
                    		<div class="chat-system">
                                ...
                                <div class="user-list-box">
                                    ...
                                    <div class="people" id="getchat"></div>
                                </div>
                                <div class="chat-box">
	...
	<script src="<?=base_url('themes/admin/assets/js/apps/mailbox-chat.js')?>"></script>
	<script>
		function loadchat(id,name){
			var varurl = window.location.protocol + "//" + location.hostname + "/chat/chatframe";
			$.ajax({
				type: 'post',
				url: varurl,
		...
		function getchat()
		{
			$.ajax({
				type: "GET",
				url: "<?php echo base_url().'getfunc/getchat'?>",
				success: function(response){

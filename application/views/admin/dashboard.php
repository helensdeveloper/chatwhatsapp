							...
							<div class="widget-content">
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<tr>
												<td><div class="td-content customer-name"><img src="<?=base_url().'themes/img/lk.png'?>" alt="avatar">Laurie Fox</div></td>
												<td><div class="td-content product-brand">usercs1</div></td>
											...
											<tr>
												...
												<td><div class="td-content product-brand">usercs2</div></td>
